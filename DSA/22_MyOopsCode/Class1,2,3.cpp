...
public:
    ...
    { // mene yaha jo value aai hai uska name bhi same hi rakh dea jo uper declare kiya hia tabhi this use hoga
        this->weight = weight;
        // or
        //  (*this).weight = weight;
    }
...
{ // replace with private and protected as well to see the behaviour
public:
    void print()
    {
        cout << age;
...
//!Operator Overloading
 class Number{
    ...
    Number operator+ (Number obj){
        return Number(value - obj.value);//very easy and basic example of operator overloading!1
    }
 };
...
int main()
{
    ...
    //Note: Compile time polymorphism me function overloading ka example to me likh nahi raha 
    //kuki vo bahut jada easy hai me sirf niche Operator overloading ka example de raha hu!!
   
    //!Operator Overloading
    
    //Number a(10);//a ek object hai jisme 10 pass kiya hai 
    //Number b(5);//b ek object hai jisme 5 pass kiya hai 
    //Number c = a + b; //socha to default behavior 15 ans ana cahiye cpp ka lekin operator overloadin
                     //ke wajah se hum alag tarah se treat karenge name alag kaam alag
